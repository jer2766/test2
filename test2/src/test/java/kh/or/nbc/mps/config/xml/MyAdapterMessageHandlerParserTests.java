 ...
 *
 */
public class MyAdapterMessageHandlerParserTests {
	...
	public void testMessageHandlerParser() throws Exception {
		setUp("MyAdapterMessageHandlerParserTests.xml", getClass());
	...
	public void testExecutorBeanIdNaming() throws Exception {
		...
		this.context = new ClassPathXmlApplicationContext("MyAdapterMessageHandlerParserTests.xml", getClass());
		assertNotNull(context.getBean("myadapterOutboundChannelAdapter.myadapterExecutor", MyAdapterExecutor.class));
	...
	public void setUp(String name, Class<?> cls){
		...
		consumer   = this.context.getBean("myadapterOutboundChannelAdapter", EventDrivenConsumer.class);
	}
